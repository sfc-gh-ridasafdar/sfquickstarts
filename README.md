...
10. Navigate back to the main repo Snowflake-Labs/sfquickstarts. At the top you will see a yellow box with a button to 'compare & pull request.' Click this and create + submit your pull request for approval.
...
8. Navigate back to the main repo Snowflake-Labs/sfquickstarts. At the top you will see a yellow box with a button to 'compare & pull request.' Click this and create + submit your pull request for approval.
    > Note: It is recommended to create a draft pull request, run all your checks, then mark as ready for review, so we know it's ready to merge immediately.
